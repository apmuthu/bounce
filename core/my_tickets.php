...
-->
  ...
  <tr>
    <td bgcolor="#FFFFFF"> <table width="600" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#333333">
		<tr>
		  <td colspan="4" background="./images/dark_blue.png" bgcolor="#333333"><span class="style1"><?php echo "$tech_first"; ?>'s Open / PendingTickets</span></td>
		</tr>
	...
	<?php
			$result_client = mysql_query("SELECT * FROM tickets WHERE ownerid='$tech_id' and Status!= 'Closed'")or die (mysql_error());		
			while($row_client = mysql_fetch_array($result_client))
			{
				...
				?>
				  ...
				  <td width="25%" bgcolor="#FFFFFF" class="style2"><a href='view_tickets.php?func=ticket&id=<?php echo "$row_client[id]"; ?>'>View</a> | <a href="update_tickets.php?func=statusupdate&id=<?php echo "$row_client[id]"; ?>&status=Closed&page=my_tickets.php">Close</a> </td>
				  </tr>	
				<?php
